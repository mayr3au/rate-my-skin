export const translations = {
  ...
  fr: {
    ...
    heroLine2: 'Diagnostic peau IA · Score & conseils personnalisés',
    heroLine3: 'Toujours gratuit. D\u00e9tails complets d\u00e8s 7,99 \u20ac.',
    heroDesc: 'Analyse de peau gratuite par IA — diagnostic peau personnalisé en 30 secondes. Score peau, conseils skincare et produits adaptés à votre type de peau.',
    pourquoiH2: 'Pourquoi noter sa peau avec l\'IA ?',
    pourquoiDesc: 'Notre IA analyse 8 métriques cliniques — hydratation, éclat, acné, pores dilatés, taches brunes, cernes — pour vous donner un score peau précis et un diagnostic peau personnalisé. Analyser sa peau n\'a jamais été aussi simple : une photo, 30 secondes, un rapport complet.',
