export const translations = {
  en: {
    ...
    pdfCardTitle: 'Your Report to Go',
    pdfCardDesc: 'Keep your complete analysis as a PDF: an elegant 5-page document to archive, print, or share. Ideal for tracking your routine over time or consulting your dermatologist.',
  ...
  fr: {
    ...
    pdfCardTitle: 'Votre rapport à emporter',
    pdfCardDesc: 'Conservez votre analyse complète au format PDF : un document élégant de 5 pages à archiver, imprimer ou partager. Idéal pour suivre votre routine sur la durée ou consulter votre dermatologue.',
