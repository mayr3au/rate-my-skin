export const translations = {
  en: {
    ...
    refineAnalysis: 'Refine my analysis (optional)',
    ...
    paywallFeatures: [
      { icon: '\u25ce', title: '8 Skin Metrics, Scored & Graded', desc: 'Hydration \u00b7 Radiance \u00b7 Pores \u00b7 Acne \u00b7 Dark Spots \u00b7 Under-Eye \u00b7 Texture \u00b7 Redness \u2014 each rated and clinically explained.' },
    ...
    landingHook: 'Rate your skin in 30 seconds',
    landingValue: 'Free analysis \u00b7 Full report from \u20ac7.99',
    skipQuestions: 'Analyze now \u2192',
    questionsTitle: 'Refine my analysis',
    photoTipCondensed: 'Good lighting \u00b7 Centered face \u00b7 Close-up',
    ...
    pourquoiDesc: 'Our AI skin analysis examines 8 clinical metrics \u2014 hydration, radiance, acne, pores, dark spots, under-eye, texture, and redness \u2014 to give you a precise skin score and personalised advice. Testing your skin has never been easier: one photo, 30 seconds, a complete report.',
    ...
    myReportsDesc: 'Enter your email to access all your analyses.',
    myReportsButton: 'View My Reports \u2192',
    myReportsLoading: 'Loading\u2026',
    myReportsEmpty: 'No reports found for this email address.',
    ...
    faqA1: 'Our AI skin analysis examines 8 clinical metrics — hydration, radiance, acne, pores, dark spots, under-eye, texture, and redness — to give you a precise skin score and personalised advice. Testing your skin has never been easier: one photo, 30 seconds, a complete report.',
  ...
  fr: {
    ...
    refineAnalysis: 'Affiner mon analyse (optionnel)',
    ...
    paywallFeatures: [
      { icon: '\u25ce', title: '8 Métriques de peau, notées & expliquées', desc: 'Hydratation \u00b7 \u00c9clat \u00b7 Pores \u00b7 Acn\u00e9 \u00b7 Taches \u00b7 Cernes \u00b7 Texture \u00b7 Rougeurs \u2014 chacune \u00e9valu\u00e9e cliniquement.' },
    ...
    landingHook: 'Note ta peau en 30 secondes',
    landingValue: 'Analyse gratuite \u00b7 Rapport complet d\u00e8s 7,99\u20ac',
    skipQuestions: 'Analyser maintenant \u2192',
    questionsTitle: 'Affiner mon analyse',
    photoTipCondensed: 'Bonne lumi\u00e8re \u00b7 Visage centr\u00e9 \u00b7 Gros plan',
    ...
    pourquoiDesc: 'Notre IA analyse 8 métriques cliniques · hydratation, éclat, acné, pores dilatés, taches brunes, cernes, texture et rougeurs · pour vous donner un score de peau précis et un diagnostic personnalisé. Analyser sa peau n\'a jamais été aussi simple : une photo, 30 secondes, un rapport complet.',
    ...
    myReportsDesc: 'Entrez votre email pour accéder à vos analyses.',
    myReportsButton: 'Voir mes rapports →',
    myReportsLoading: 'Chargement…',
    myReportsEmpty: 'Aucun rapport trouvé pour cette adresse email.',
    ...
    faqA1: 'Notre IA analyse 8 métriques cliniques · hydratation, éclat, acné, pores dilatés, taches brunes, cernes, texture et rougeurs · pour vous donner un score de peau précis et un diagnostic personnalisé. Analyser sa peau n\'a jamais été aussi simple : une photo, 30 secondes, un rapport complet.',
