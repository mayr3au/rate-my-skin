export const translations = {
  en: {
    ...
    // Email gate modal
    reward: 'Reward',
    unlock2ndFree: 'Unlock a 2nd free analysis',
    emailGateDesc: 'Enter your email to claim a free second report — plus weekly skin tips delivered to your inbox.',
    claimFreeAnalysis: 'Claim free analysis →',
    saving: 'Saving…',
    ...
    fiveAnalyses: '5 analyses · one-time',
    ...
    heroLine3: 'Free for your first 2 analyses.',
    ...
    upsellDesc: 'Get 5 more full analyses for a one-time payment.',
    get5For499: 'Get 5 for €4.99 →',

    // Payment success
    paymentSuccess: 'Payment successful — 5 analyses added to your account.',
  ...
  fr: {
    ...
    // Email gate modal
    reward: 'Récompense',
    unlock2ndFree: 'Débloquez une 2ème analyse gratuite',
    emailGateDesc: 'Entrez votre email pour obtenir un deuxième rapport offert — et recevez des conseils beauté chaque semaine.',
    claimFreeAnalysis: 'Obtenir mon analyse gratuite →',
    saving: 'Enregistrement…',
    skipToResults: 'Passer — voir les résultats',
    ...
    fiveAnalyses: '5 analyses · paiement unique',
    ...
    heroLine3: 'Gratuit les 2 premières fois.',
    ...
    upsellDesc: 'Obtenez 5 analyses complètes en un paiement unique.',
    get5For499: 'Obtenir 5 pour 4,99 € →',

    // Payment success
    paymentSuccess: 'Paiement réussi — 5 analyses ajoutées à votre compte.',
