...
export default function BeautyReport({
  ...
  useEffect(() => {
    const handleBeforeUnload = () => {
      if (hasClickedCheckout && !isPaid && !window.rms_is_redirecting_to_stripe) {
        if (typeof window !== 'undefined' && window.gtag) {
  ...
  return (
    <div style={{ background: "transparent", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", paddingBottom: 80 }}>
      ...
      <>
          ...
          {!isPaid && (
            <div className="paywall-outer-wrapper" style={{ maxWidth: 680, margin: "48px auto 0", padding: "0 20px" }}>
              <div className="paywall-container" style={{
                ...
                <div className="paywall-social-dot" style={{
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  gap: "8px",
                ...
                {/* Medical disclaimer */}
                <p className="paywall-disclaimer" style={{ fontSize: 10.5, color: "#B9AC9E", textAlign: "center", margin: "0 auto 20px", fontFamily: "'Inter', sans-serif", lineHeight: 1.55, maxWidth: "480px" }}>
                  {lang === 'fr'
                ...
                <div className="paywall-testimonial-card" style={{
                  margin: "24px auto 0",
                  padding: "16px 20px",
                  borderRadius: "14px",
                ...
                {/* Value comparison */}
                <div className="paywall-value-comparison" style={{
          ...
          {/* CTA Sticky en bas de l'écran (Mobile uniquement) */}
          {!isPaid && (
            <div className="mobile-sticky-pay-bar" style={{
              position: "fixed",
              bottom: 0,
              left: 0,
              right: 0,
              ...
              >
                {unlocking ? (
                  <span style={{ fontSize: "13px" }}>{t('redirecting')}</span>
                ) : (
                  <span>
                    {lang === 'fr'
                      ? "Débloquer mon rapport • 7,99 €"
                      : "Unlock my report • 7.99 €"}
                  </span>
                )}
              </button>
            </div>
